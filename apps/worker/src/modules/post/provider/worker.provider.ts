...
export const WORKER_ADAPTER_SERVICES: WorkerAdapters[] = [
  ...
  },
  {
    ...
    concurrency: parseInt(process.env.PRODUCER_ATTACH_DETACH_NEWSFEED_CONCURRENCY) | 10,
  },
  {
    ...
    concurrency: parseInt(process.env.ATTACH_DETACH_NEWSFEED_CONCURRENCY) | 10,
  },
  {
    ...
    concurrency: parseInt(process.env.PRODUCER_FOLLOW_UNFOLLOW_CONCURRENCY) | 10,
  },
  {
    ...
    concurrency: parseInt(process.env.FOLLOW_UNFOLLOW_GROUPS_CONCURRENCY) | 10,
  },
];
