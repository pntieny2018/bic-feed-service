 ...
 */
export function addJitter(time: number, variance = 0.1): number {
...
export function getDelay(numOfRetries: number, limit = 300): number {
...
export function getDelayWithJitter(numOfRetries: number, limit = 300, variance = 0.1): number {
