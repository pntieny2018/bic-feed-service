...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    return queryInterface
      ...
      .then(() => {
        return queryInterface.addColumn(
          { tableName: `media`, schema: schemaName },
          'uuid',
          {
            type: Sequelize.UUID,
            defaultValue: Sequelize.literal('public.gen_random_uuid()'),
      ...
      .then(() => {
        return queryInterface.addColumn(
          { tableName: `mentions`, schema: schemaName },
          'uuid',
          {
            type: Sequelize.UUID,
            defaultValue: Sequelize.literal('public.gen_random_uuid()'),
      ...
      .then(() => {
        ...
        return Promise.all([
          queryInterface.addColumn(
            { tableName: `comment_edited_history`, schema: schemaName },
            'comment_uuid',
            {
              type: Sequelize.UUID,
            },
          ...
          queryInterface.addColumn(
            { tableName: `post_edited_history`, schema: schemaName },
            'post_uuid',
            {
              type: Sequelize.UUID,
            },
      ...
      .then(() => {
        ...
        return Promise.all([
          ...
          queryInterface.removeColumn({ tableName: `comments`, schema: schemaName }, 'post_id', {
            transaction: t,
          }),
          queryInterface.removeColumn({ tableName: `comments`, schema: schemaName }, 'parent_id', {
            transaction: t,
          }),
          queryInterface.removeColumn(
            { tableName: `comments_media`, schema: schemaName },
          ...
          queryInterface.removeColumn({ tableName: `mentions`, schema: schemaName }, 'entity_id', {
            transaction: t,
          }),
          queryInterface.removeColumn(
            { tableName: `post_edited_history`, schema: schemaName },
          ...
          queryInterface.removeColumn({ tableName: `posts_media`, schema: schemaName }, 'post_id', {
            transaction: t,
          }),
          queryInterface.removeColumn(
            { tableName: `posts_media`, schema: schemaName },
      ...
      .then(() => {
        ...
        return Promise.all([
          queryInterface.removeColumn({ tableName: `posts`, schema: schemaName }, 'id', {
            transaction: t,
          }),
          queryInterface.removeColumn({ tableName: `comments`, schema: schemaName }, 'id', {
            transaction: t,
          }),
          queryInterface.removeColumn({ tableName: `media`, schema: schemaName }, 'id', {
            transaction: t,
          }),
          queryInterface.removeColumn({ tableName: `posts_reactions`, schema: schemaName }, 'id', {
            transaction: t,
          }),
          queryInterface.removeColumn(
            { tableName: `comments_reactions`, schema: schemaName },
          ...
          queryInterface.removeColumn({ tableName: `mentions`, schema: schemaName }, 'id', {
            transaction: t,
          }),
        ]);
      })
      .then(() => {
        // rename temp primary key col
        return Promise.all([
          queryInterface.renameColumn({ tableName: `posts`, schema: schemaName }, 'uuid', 'id', {
            transaction: t,
          }),
          queryInterface.renameColumn({ tableName: `comments`, schema: schemaName }, 'uuid', 'id', {
            transaction: t,
          }),
          queryInterface.renameColumn({ tableName: `media`, schema: schemaName }, 'uuid', 'id', {
            transaction: t,
          }),
          ...
          queryInterface.renameColumn({ tableName: `mentions`, schema: schemaName }, 'uuid', 'id', {
            transaction: t,
          }),
        ]);
      })
      .then(() => {
        // add primary key constrains
        return Promise.all([
