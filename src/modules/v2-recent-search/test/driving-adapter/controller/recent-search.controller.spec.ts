...
import { RecentSearchNotFoundException } from '../../../../v2-post/exception/recent-search-not-found.exception';
...
describe('RecentSearchController', () => {
    ...
    describe('Create', () => {
      ...
      it('Should create recent search successfully', async () => {
        ...
        const result = await recentSearchController.createRecentSearch(userMock, createRecentSearchDto);
    ...
    describe('Delete', () => {
      ...
      it('Should delete recent search successfully', async () => {
        ...
        const result = await recentSearchController.deleteRecentSearch(userMock, deleteRecentSearchDto);
