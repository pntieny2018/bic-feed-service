...
import {
  COMMENT_REACTION_REPOSITORY_TOKEN, ICommentReactionRepository,
...
import { IReactionDomainService, REACTION_DOMAIN_SERVICE_TOKEN } from '../../../domain/domain-service/interface';
...
describe('CreateReactionHandler', () => {
  ...
  beforeEach(async () => {
    ...
    commentReactionRepository = module.get<ICommentReactionRepository>(COMMENT_REACTION_REPOSITORY_TOKEN);
